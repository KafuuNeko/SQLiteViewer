...
import cc.kafuu.sqliteviewer.common.utils.FileUtils.bytesCountToReadableFileSize
import java.io.File
...
data class SQLiteFile(val name: String, val file: File, val tableCount: Int, val viewCount: Int) {
    fun getFileDetails(): String {
        ...
        val lastModified =
            SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.getDefault()).format(file.lastModified())
